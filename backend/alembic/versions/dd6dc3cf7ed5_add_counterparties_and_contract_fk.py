...
Revision ID: dd6dc3cf7ed5
Revises: 0b221ccc449c
Create Date: 2025-12-25 08:56:36.481448
...
def upgrade() -> None:
    ...
    # Add counterparty_id column to contracts table
